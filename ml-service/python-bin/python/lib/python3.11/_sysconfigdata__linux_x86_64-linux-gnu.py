...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                ...
                ' -fPIC  '
                "' 'LDFLAGS=  "
                "-Wl,--exclude-libs,ALL' 'CPPFLAGS=  "
                "-fPIC  '",
 'CONFINCLUDEDIR': '/install/include',
 'CONFINCLUDEPY': '/install/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.11.9/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/Python-3.11.9/lcov-report',
 ...
 'LIBEXPAT_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g -fwrapv -O3 '
                    '-Wall  -fPIC '
                    '  '
                    '-flto -g -std=c11 -Wextra -Wno-unused-parameter '
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.11.9 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.11.9/`cat pybuilddir.txt`:)./Lib '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/Python-3.11.9',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/Python-3.11.9 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.11.9 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.9/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu '
               '/tools/host/bin/python3.11',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/Python-3.11.9 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.11.9 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.9/`cat pybuilddir.txt`:)./Lib '
 ...
 'abs_builddir': '/build/Python-3.11.9',
 'abs_srcdir': '/build/Python-3.11.9',
